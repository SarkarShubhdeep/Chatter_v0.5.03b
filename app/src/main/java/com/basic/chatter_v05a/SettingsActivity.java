            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(!image.equals("default")){
                    ...
                    Picasso.with(SettingsActivity.this).load(image)
                            .networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.avatar).into(mDisplayimage, new Callback() {
                        @Override
...
//            Toast.makeText(SettingsActivity.this,imageUri,Toast.LENGTH_LONG).show();
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                final StorageReference thumb_pathfile = mImageStorage.child("profile_images").child("thumbs").child(current_user_id + ".jpg");
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if(task.isSuccessful()){
                           ...
                           // Toast.makeText(SettingsActivity.this,"working",Toast.LENGTH_LONG).show();
                            ...
                            UploadTask uploadTask = thumb_pathfile.putBytes(thumb_byte);
